...
public class Faqs extends Fragment {
    ...
    private FaqCardsAdapter mFaqCardsAdapter;
    public Faqs(){}
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mFaqCardsAdapter = new FaqCardsAdapter(getActivity(),8);
        SwingBottomInAnimationAdapter swingBottomInAnimationAdapter=new SwingBottomInAnimationAdapter(mFaqCardsAdapter) ;
